...
if("function"==typeof Object.setPrototypeOf)ba=Object.setPrototypeOf;else{var ca;a:{var da={sa:!0},ea={};try{ea.__proto__=da;ca=ea.sa;break a}catch(a){}ca=!1}ba=ca?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var ha=ba;
function n(a,b){a.prototype=aa(b.prototype);a.prototype.constructor=a;if(ha)ha(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.o=b.prototype}
...
O.shouldRetry())Fd(".google.com")&&(N[1]=".google.com"),O.fa();else{m=Gd.googleToken=Gd.googleToken||{};u=0==e&&f&&r(f)&&0<g&&0<h&&r(k);var fa=!(M[3]>=z())&&(5==e||4==e||2==e);if(u||fa)u=z(),m[5]=e,m[1]=f,m[2]=u+1E3*g,m[3]=u+1E3*h,m[4]=k,m[6]=b,Id();if(f||!O.ka()){e=O.ja();for(f=0;f<e.length;f++)O.ha(e[f]);e.length=0}}};
Kd(a)}
...
function Pd(a){return Q(a,void 0)}
;function Qd(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){R(b)}}:a}
function R(a,b){var c=v("yt.logging.errors.log");c?c(a,b,void 0,void 0,void 0):(c=Q("ERRORS",[]),c.push([a,b,void 0,void 0,void 0]),P("ERRORS",c))}
...
;function T(a,b){ta(a)&&(a=Qd(a));return window.setTimeout(a,b)}
...
try{Zd[a]?f():T(f,0)}catch(g){R(g)}},void 0);
...
function ie(a,b){var c=je(a),d=document.getElementById(c),e=d&&Td(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){e=$d(c,b);var g=""+(b[va]||(b[va]=++wa));ke[g]=e}f||(d=le(a,c,function(){Td(d,"loaded")||(Rd(d),ce(c),T(y(de,c),0))}))}}
...
function ne(a,b){if(a&&b){var c=""+(b[va]||(b[va]=++wa));(c=ke[c])&&be(c)}}
function je(a){var b=document.createElement("a");Eb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+La(a)}
var ke={};var oe=null;function pe(){var a=Q("BG_I",null),b=Q("BG_IU",null),c=Q("BG_P",void 0);b?he(b,function(){window.botguard?qe(c):(me(b),R(Error("Unable to load Botguard from "+b),"WARNING"))}):a&&(eval(a),window.botguard?qe(c):R(Error("Unable to load Botguard from JS"),"WARNING"))}
function qe(a){oe=new window.botguard.bg(a);S("botguard_periodic_refresh")&&Nd()}
...
;function we(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=decodeURIComponent((e[0]||"").replace(/\+/g," "));e=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?w(b[f])?Sa(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
b.la&&0<b.timeout&&(f=T(function(){e||(e=!0,Vd(f),b.la.call(b.context||p))},b.timeout))}else De(a,b)}
function De(a,b){var c=b.format||"JSON";a=Be(a,b);var d=Ce(a,b),e=!1,f,g=Ee(a,function(a){if(!e){e=!0;f&&Vd(f);var d=ve(a),g=null;if(d||400<=a.status&&500>a.status)g=Fe(c,a,b.Xa);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||p;d?b.C&&b.C.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.ea&&b.ea.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.K&&0<b.timeout&&(f=T(function(){e||(e=!0,g.abort(),Vd(f),b.K.call(b.context||p,g))},b.timeout))}
function Be(a,b){b.za&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.Ua;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=we(f[1]||"");for(var g in d)f[g]=d[g];a=ud(c,f)+e}return a}
function Ce(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.w,g=Pd("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.Ya||rd(L(a)[3]||null)&&!b.withCredentials&&rd(L(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.w&&b.w[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=we(e),db(e,f),e=b.ma&&"JSON"==b.ma?JSON.stringify(e):td(e));f=e||f&&!$a(f);!ye&&f&&"POST"!=b.method&&(ye=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
return d}
function Ie(a){if(ua(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Db(a[b]);a[c]=d}else Ie(a[b])}}
...
;var Ke={},Le=0;function Me(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Ta,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a=Lb("IFRAME",{src:'javascript:"data:text/html,<body><img src=\\"'+a+'\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a)):e?Ee(a,b,"POST",e,d):Q("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Ee(a,b,"GET","",d):Ne(a,b))}
function Ne(a,b){var c=new Image,d=""+Le++;Ke[d]=c;c.onload=c.onerror=function(){b&&Ke[d]&&b();delete Ke[d]};
c.src=a}
;var Oe={},Pe=0;
function Qe(a,b,c,d,e,f){f=f||{};f.name=c||Q("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=Pe)){e=a.stacktrace;c=a.columnNumber;d=v("window.location.href");if(r(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=!1;try{var h=a.lineNumber||a.line||"Not available"}catch(fa){h="Not available",g=!0}try{var k=
a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(fa){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(Oe[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=e;h={Ua:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),
...
;var Re=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};t("yt.msgs_",Re,void 0);function Se(a){Md(Re,arguments)}
;function Te(a,b){var c=5E3;isNaN(c)&&(c=void 0);var d=v("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):T(a,c||0)}
function Ue(a){if(!isNaN(a)){var b=v("yt.scheduler.instance.cancelJob");b?b(a):Vd(a)}}
;var Ve=[],We=!1;function Xe(){function a(){We=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)}
he("//static.doubleclick.net/instream/ad_status.js",a);Ve.push(Te(function(){We||"google_ad_status"in window||(ne("//static.doubleclick.net/instream/ad_status.js",a),P("DCLKSTAT",3))},1))}
function Ye(){return parseInt(Q("DCLKSTAT",0),10)}
...
af.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Za=v("ytEventsEventsListeners")||{};t("ytEventsEventsListeners",Za,void 0);var bf=v("ytEventsEventsCounter")||{count:0};t("ytEventsEventsCounter",bf,void 0);function cf(a,b,c,d){d=void 0===d?!1:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return Ya(function(e){return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&e[4]==!!d})}
function df(a,b,c){var d=void 0===d?!1:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=cf(a,b,c,d);if(e)return e;e=++bf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new af(d);if(!Nb(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new af(b);
b.currentTarget=a;return c.call(a,b)};
g=Qd(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,g,d)):a.attachEvent("on"+b,g);Za[e]=[a,b,c,g,d];return e}
function ef(a){a&&("string"==typeof a&&(a=[a]),C(a,function(a){if(a in Za){var b=Za[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Za[a]}}))}
;function ff(){if(null==v("_lact",window)){var a=parseInt(Q("LACT"),10);a=isFinite(a)?z()-Math.max(a,0):-1;t("_lact",a,window);t("_fact",a,window);-1==a&&U();df(document,"keydown",U);df(document,"keyup",U);df(document,"mousedown",U);df(document,"mouseup",U);df(window,"popstate",U);$d("page-mouse",U);$d("page-scroll",U);$d("page-resize",U)}}
function U(){null==v("_lact",window)&&ff();var a=z();t("_lact",a,window);-1==v("_fact",window)&&t("_fact",a,window);(a=v("ytglobal.ytUtilActivityCallback_"))&&a()}
...
;function lf(){if(!mf&&!nf||!window.JSON)return null;try{var a=mf.get("yt-player-two-stage-token")}catch(b){}if(!r(a))try{a=nf.get("yt-player-two-stage-token")}catch(b){}if(!r(a))return null;try{a=JSON.parse(a,void 0)}catch(b){}return a}
var nf,of=new md;nf=of.isAvailable()?new id(of):null;var mf,pf=new nd;mf=pf.isAvailable()?new id(pf):null;function qf(){var a=Q("ROOT_VE_TYPE",void 0);return a?new hf(void 0,a,void 0):null}
function rf(){var a=Q("client-screen-nonce")||Q("EVENT_ID");return a?a:null}
;function sf(a,b,c){Yb.set(""+a,b,c,"/","youtube.com",!1)}
;function tf(a){if(a){a=a.itct||a.ved;var b=v("yt.logging.screen.storeParentElement");a&&b&&b(new hf(a))}}
;function uf(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=rd(L(window.location.href)[3]||null);f&&e.push(f);f=rd(L(d)[3]||null);if(0<=Ma(e,f)||!f&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(e=document.createElement("a"),Eb(e,d),d=e.href),d){f=L(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
rf();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+La(d).toString(36),e=b?td(b):"",sf(d,e,h||5),tf(b))}else h="ST-"+La(d).toString(36),d=b?td(b):"",sf(h,d,5),tf(b)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var u=void 0===u?window:u;c=u.location;a=ud(a,k)+m;a=a instanceof G?a:Ab(a);c.href=yb(a)}return!0}
;t("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||re,void 0);t("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||se,void 0);t("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||Ye,void 0);t("yt.player.exports.navigate",v("yt.player.exports.navigate")||uf,void 0);t("yt.util.activity.init",v("yt.util.activity.init")||ff,void 0);t("yt.util.activity.getTimeSinceActive",v("yt.util.activity.getTimeSinceActive")||gf,void 0);
t("yt.util.activity.setTimestamp",v("yt.util.activity.setTimestamp")||U,void 0);var vf={log_event:"events",log_interaction:"interactions"},wf=Object.create(null);wf.log_event="GENERIC_EVENT_LOGGING";wf.log_interaction="INTERACTION_LOGGING";var xf={},yf={},zf=0,V=v("ytLoggingTransportLogPayloadsQueue_")||{};t("ytLoggingTransportLogPayloadsQueue_",V,void 0);var Af=v("ytLoggingTransportTokensToCttTargetIds_")||{};t("ytLoggingTransportTokensToCttTargetIds_",Af,void 0);var Bf=v("ytLoggingTransportDispatchedStats_")||{};t("ytLoggingTransportDispatchedStats_",Bf,void 0);
t("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{},void 0);function Cf(a,b){yf[a.endpoint]=b;if(a.V){var c=a.V;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);Af[a.V.token]=d;c=Df(a.endpoint,a.V.token)}else c=Df(a.endpoint);c.push(a.payload);c.length>=(Number(S("web_logging_max_batch")||0)||20)?Ef():Ff()}
function Ef(){Vd(zf);if(!$a(V)){for(var a in V){var b=xf[a];if(!b){var c=yf[a];if(!c)continue;b=new c;xf[a]=b}c=void 0;var d=a,e=b,f=vf[d],g=Bf[d]||{};Bf[d]=g;b=Math.round(Nd());for(c in V[d]){var h=e.b;h={client:{hl:h.Ca,gl:h.Ba,clientName:h.Aa,clientVersion:h.innertubeContextClientVersion}};Q("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});h={context:h};h[f]=Df(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=h[f].length;h.requestTimeMs=
b;var k=Af[c];if(k)a:{var m=h,u=c;if(k.videoId)var fa="VIDEO";else if(k.playlistId)fa="PLAYLIST";else break a;m.credentialTransferTokenTargetId=k;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:u,scope:fa}]}delete Af[c];Gf(e,d,h)}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete V[a]}$a(V)||
Ff()}}
function Ff(){Vd(zf);zf=T(Ef,Q("LOGGING_BATCH_TIMEOUT",1E4))}
function Df(a,b){b||(b="");V[a]=V[a]||{};V[a][b]=V[a][b]||[];return V[a][b]}
;function Hf(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||Nd());f[a]=b;f.context={lastActivityMs:String(d?-1:gf())};Cf({endpoint:"log_event",payload:f,V:e},c)}
...
;function Jf(a){this.b=a||{innertubeApiKey:Pd("INNERTUBE_API_KEY"),innertubeApiVersion:Pd("INNERTUBE_API_VERSION"),Aa:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Pd("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ca:Pd("INNERTUBE_CONTEXT_HL"),Ba:Pd("INNERTUBE_CONTEXT_GL"),Da:Pd("INNERTUBE_HOST_OVERRIDE")||""}}
function Gf(a,b,c){var d={};!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":Q("VISITOR_DATA","")},method:"POST",w:c,ma:"JSON",K:function(){d.K()},
la:d.K,C:function(a,b){d.C&&d.C(b)},
ab:function(a){d.C&&d.C(a)},
onError:function(a,b){if(d.onError)d.onError(b)},
Za:function(a){if(d.onError)d.onError(a)},
timeout:d.timeout,withCredentials:!0},f=Zb();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=Q("SESSION_INDEX",0));var g="",h=a.b.Da;h&&(g=h);f&&!g&&(e.headers["x-origin"]=window.location.origin);a=""+g+If(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey;S("use_fetch_for_op_xhr")?Ae(a,e):Je(a,e)}
;function Kf(a,b,c){Lf(Jf,{attachChild:{csn:a,parentVisualElement:kf(b),visualElements:[kf(c)]}})}
function Lf(a,b,c){b.eventTimeMs=c?c:Math.round(Nd());b.lactMs=gf();Cf({endpoint:"log_interaction",payload:b},a)}
...
function Vf(a){var b=Wf(a),c=document.getElementById(b),d=c&&Td(c,"loaded");d||c&&!d||(c=Xf(a,b,function(){Td(c,"loaded")||(Rd(c),ce(b),T(y(de,b),0))}))}
...
function Eg(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}b=Fg();var c=Nd();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=pg();if(c=b[a])Ue(c),b[a]=0;Gg()["tick_"+a]=void 0;Nd();S("csi_on_gel")?(b=Hg(),"_start"==a?jg("baseline_"+b)||Hf("latencyActionBaselined",{clientActionNonce:b},Jf,void 0,void 0):jg("tick_"+a+"_"+b)||Hf("latencyActionTicked",{tickName:a,clientActionNonce:b},Jf,void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");
if(a&&(b=Pd("TIMING_ACTION"),a=Fg(),v("ytglobal.timingready_")&&b&&a._start&&(b=Ig()))){S("tighter_critical_section")&&!Dg&&(og(wg,new rg(Math.round(b-a._start),void 0)),Dg=!0);b=!0;c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Jg()}}
function Kg(){var a=Lg().info.yt_lt="hot_bg";Gg().info_yt_lt=a;if(S("csi_on_gel"))if("yt_lt"in Ag){var b={},c=Ag.yt_lt;0<=Ma(Cg,c)&&(a=!!a);c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=Hg();c=Object.keys(b).join("");jg("info_"+c+"_"+a)||(b.clientActionNonce=a,Hf("latencyActionInfo",b,Jf,void 0,void 0))}else 0<=Ma(Bg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
...
function Jg(){qg();if(!S("csi_on_gel")){var a=Fg(),b=Lg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in zg){var f=Oa(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Mg(f,e),Ng(),Og(),Pg(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:Q("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+v("ytplayer.config.assets.js");(k=X.getEntriesByName?X.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
...
var Og=x(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||qa,X);
function Mg(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Me(a,void 0,void 0,void 0,f)}catch(g){Me(a,void 0,void 0,void 0,f)}}else Me(a);Pg(!0,c)}
...
function Ug(a){var b=!0,c=Xg(a);c&&a.b&&(a=a.b,b=Td(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
...
a.L=!0;b?a.F():(he(a.b.assets.js,a.F),Uf(a.b.assets.css),Zg(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
...
this.i[e]);Wg(this);this.P&&this.P(this.f);this.A.G("onReady",this.f)}}else this.ga=T(x(this.X,this),50)}};
function $g(a,b,c){var d=b[c];return function(){try{return a.Y=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Y=e,R(e,"WARNING"))}}}
function Sg(a){a.u=!1;if(a.O)for(var b in a.i)a.O(b,a.i[b]);for(var c in a.N)Vd(parseInt(c,10));a.N={};a.H=null;a.O=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=x(a.U,a);a.f.removeEventListener=x(a.Ma,a);a.f.destroy=x(a.dispose,a);a.f.getLastError=x(a.xa,a);a.f.getPlayerType=x(a.ya,a);a.f.getCurrentVideoConfig=x(a.wa,a);a.f.loadNewVideoConfig=x(a.da,a);a.f.isReady=x(a.Ea,a)}
l.Ea=function(){return this.u};
l.U=function(a,b){if(!this.g){var c=Tg(this,b);if(c){if(!(0<=Ma(this.qa,a)||this.i[a])){var d=ah(this,a);this.H&&this.H(a,d)}this.A.subscribe(a,c);"onReady"==a&&this.u&&T(y(c,this.f),0)}}};
...
function ah(a,b){var c="ytPlayer"+b+a.I,d=x(function(a){if("html5"==(Xg(this)?"html5":null)){var c=this.b&&this.b.args&&this.b.args.fflags;if(c&&0>c.indexOf("use_html5_player_event_timeout=true")){this.A.G(b,a);return}}var d=T(x(function(){if(!this.g){this.A.G(b,a);var c=this.N,e=String(d);e in c&&delete c[e]}},this),0);
...
l.l=function(){Yg(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.S=null;for(var a in this.i)p[this.i[a]]=null;this.Z=this.b=this.f=null;delete this.R;delete this.m;I.prototype.l.call(this)};
function Zg(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var bh={},ch="player_uid_"+(1E9*Math.random()>>>0);function dh(a){var b="player";b=r(b)?Ib(b):b;a=Qf(a);var c=ch+"_"+(b[va]||(b[va]=++wa)),d=bh[c];if(d)return d.da(a),d.f;d=new Rg(b,c);bh[c]=d;ce("player-added",d.f);nc(d,y(eh,d));T(function(){d.da(a)},0);
return d.f}
...
qh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=yc(a);c.postMessage(d,this.u)}catch(e){R(e,"WARNING")}}};
...
xh.prototype.l=function(){this.h=this.f=null;xh.o.l.call(this)};function yh(a,b,c){I.call(this);this.b=a;this.h=c;this.i=df(window,"message",x(this.j,this));this.f=new xh(this,a,b);nc(this,y(oc,this.f))}
...
yh.prototype.l=function(){ef(this.i);this.b=null;yh.o.l.call(this)};function zh(){var a=Ah()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=bb(Bh);return new J(function(c,d){b.C=function(a){ve(a)?c(a):d(new Ch("Request failed, status="+a.status,"net.badstatus"))};
...
Dh.prototype.then=function(a,b,c){return this.f?this.f.then(a,b,c):1===this.g&&a?(a=a.call(c,this.b),Fc(a)?a:Eh(a)):2===this.g&&b?(a=b.call(c,this.b),Fc(a)?a:Fh(a)):this};
Dh.prototype.getValue=function(){return this.b};
Ec(Dh);function Fh(a){var b=new Dh;a=void 0===a?null:a;b.g=2;b.b=void 0===a?null:a;return b}
function Eh(a){var b=new Dh;a=void 0===a?null:a;b.g=1;b.b=void 0===a?null:a;return b}
;function Gh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Hh;this.isTimeout=a instanceof Ch&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Tc}
n(Gh,B);Gh.prototype.name="BiscottiError";function Hh(){B.call(this,"Biscotti ID is missing from server")}
n(Hh,B);Hh.prototype.name="BiscottiMissingError";var Bh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ih=null;function Jh(){if("1"===Xa(Q("PLAYER_CONFIG",{}),"args","privembed"))return Kc(Error("Biscotti ID is not available in private embed mode"));Ih||(Ih=Sc(zh().then(Kh),function(a){return Lh(2,a)}));
return Ih}
function Ah(){var a;(a=!!Xa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie"))||(a=!!Q("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1));return a||!!S("html5_serverside_pagead_id_sets_cookie")}
...
function Nh(a,b){T(function(){Sc(zh().then(Kh,function(a){return Lh(b,a)}),qa)},a)}
function Mh(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function Oh(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Jh()}catch(b){return Kc(b)}}
;function Ph(a){B.apply(this,arguments)}
n(Ph,B);Ph.prototype.name="MutsuError";function Qh(){var a=new Ph("ID is missing"),b=new Ph("Timeout"),c=null,d=!1;Ld(function(){c=Jd();d=!0});
if(d)return c?Eh(c):Fh(a);var e=new J(function(b,c){Ld(function(){var d=Jd();d?b(d):c(a)})}),f=pd().then(function(){return Kc(b)});
return Qc(Nc([e,f]),function(){return f.cancel()})}
;function Rh(a){if("1"!==Xa(Q("PLAYER_CONFIG",{}),"args","privembed")){a&&!v("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Jh,void 0);try{var b=Oh();if(S("enable_mutsu")){v("yt.ads.mutsu.getId_")||t("yt.ads.mutsu.getId_",Qh,void 0);try{var c=v("yt.ads.mutsu.getId_")()}catch(d){c=Kc(d)}}else c=Kc(new Ph("unimplemented"));Oc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.aa||a.aa){b=b.value;a=a.value;var c={};c.dt=Sb;c.flash=zd||"0";a:{try{var d=window.top.location.href}catch(kb){d=2;break a}d=
...
H.navigator&&H.navigator.mimeTypes&&(d.u_nmime=H.navigator.mimeTypes.length);d.ca_type=yd?"flash":"image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(kb){}try{var fa=k.outerWidth;var tg=k.outerHeight}catch(kb){}try{var ug=k.innerWidth;var vg=k.innerHeight}catch(kb){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,fa,tg,ug,vg];u=window.top;try{if(u.document&&
!u.document.body)var W=new Hb(-1,-1);else{var Da=(u||window).document,Dd="CSS1Compat"==Da.compatMode?Da.documentElement:Da.body;W=(new Hb(Dd.clientWidth,Dd.clientHeight)).round()}var Ea=W}catch(kb){Ea=new Hb(-12245933,-12245933)}W={};Da=0;p.SVGElement&&p.document.createElementNS&&(Da|=1);W.bc=Da;W.bih=Ea.height;W.biw=Ea.width;W.brdim=m.join();Ea=(W.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Qb.webkitVisibilityState||Qb.mozVisibilityState||Qb.visibilityState||""]||0,W.wgl=!!H.WebGLRenderingContext,
W);for(var Ed in Ea)d[Ed]=Ea[Ed]}void 0!==b&&(d.bid=b);void 0!==a&&(d.mutsuid=a);d.bsq=Sh++;Je("//www.youtube.com/ad_data_204",{za:!1,w:d})}});
T(Rh,18E5)}catch(d){R(d)}}}
var Sh=0;var Y=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Z(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Yb.get(""+this.b,void 0)){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
...
function ai(a){var b=a.id;a=a.ve_type;var c=jf++;a=new hf(void 0,a,c,void 0,void 0);Zh[b]=a;b=rf();c=qf();b&&c&&Kf(b,c,a)}
function bi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(P("client-screen-nonce",b),P("ROOT_VE_TYPE",a),a=qf()))for(var c in Zh){var d=Zh[c];d&&Kf(b,a,d)}}
function ci(a){Zh[a.id]=new hf(a.tracking_params)}
function di(a){var b=rf();a=Zh[a.id];b&&a&&Lf(Jf,{click:{csn:b,visualElement:kf(a)}})}
function ei(a){a=a.ids;var b=rf();if(b)for(var c=0;c<a.length;c++){var d=Zh[a[c]];if(d){var e=b,f=Jf;S("interaction_logging_on_gel_web")?Hf("visualElementShown",{csn:e,ve:kf(d),eventType:1},f):Lf(f,{visibilityUpdate:{csn:e,visualElements:[kf(d)]}},void 0)}}}
function fi(){var a=Wh;a&&a.startInteractionLogging&&a.startInteractionLogging()}
;t("yt.setConfig",P,void 0);t("yt.config.set",P,void 0);t("yt.setMsg",Se,void 0);t("yt.msgs.set",Se,void 0);t("yt.logging.errors.log",Qe,void 0);
t("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);Rh(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&jh(a.args);Wh=a=dh(a);a.addEventListener("onScreenChanged",bi);a.addEventListener("onLogClientVeCreated",ai);a.addEventListener("onLogServerVeCreated",ci);a.addEventListener("onLogToGel",$h);
a.addEventListener("onLogVeClicked",di);a.addEventListener("onLogVesShown",ei);a.addEventListener("onReady",fi);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Yh=new vh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(Xh=new yh(window.parent,b,c),Yh=new ph(a,Xh.f));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&pe();Xe()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){Me(a+"mac_204?action_fcts=1");return!0},void 0);
var gi=Qd(function(){Eg("ol");var a=Z.getInstance(),b=!!((Vh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&rc(document.body,"exp-invert-logo"))if(c&&!rc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):rc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&rc(document.body,"inverted-hdpi")&&sc();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Vh(b)||0;d=c?d|67108864:d&-67108865;
0==d?delete Y[b]:Y[b]=d.toString(16).toString();a=a.b;c=[];for(var e in Y)c.push(e+"="+encodeURIComponent(String(Y[e])));sf(a,c.join("&"),63072E3)}}),hi=Qd(function(){var a=Wh;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(oe=null);a=0;for(var b=Ve.length;a<b;a++)Ue(Ve[a]);Ve.length=0;me("//static.doubleclick.net/instream/ad_status.js");We=!1;P("DCLKSTAT",0);pc(Yh,Xh);if(a=Wh)a.removeEventListener("onScreenChanged",bi),a.removeEventListener("onLogClientVeCreated",ai),a.removeEventListener("onLogServerVeCreated",ci),a.removeEventListener("onLogToGel",$h),a.removeEventListener("onLogVeClicked",di),a.removeEventListener("onLogVesShown",ei),a.removeEventListener("onReady",
fi),a.destroy();Zh={}});
